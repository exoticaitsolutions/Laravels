            ...
            <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action ="{{ route('insert') }}" method="post" enctype="multipart/form-data">
                    @csrf 
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="text_area" class="form-control" id="exampleTextarea1" rows="4"></textarea>
                    </div>
                    <div class="form-group">
                      <label>File upload</label>
                      <input type="file" name="filename" accept="image/*"  class="file-upload-default">
